        ...
        <>
            ...
            <div className="notifications">
                ...
                <div style={{ width: "375px", height: "812px", backgroundColor: "#fff", position: "relative" }}>
                    ...
                    <p style={{
                        marginLeft: "35px", marginTop: "15px", fontFamily: "Poppins-600", fontSize: "34px",
                    ...
                    <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", marginTop: "15px" }}>
                        <p style={{
                            textAlign: "center", fontFamily: "Poppins-600", fontSize: "20px", fontWeight: "600",
                            margin: "20px 0px 5px 0px", color: "#3c64c7"
                        }}>
                            No notifications yet</p>
                        <p style={{
                            textAlign: "center", fontFamily: "Poppins-600", fontSize: "15px", fontWeight: "600",
