        ...
        <>
            ...
            <div className="profile">
                ...
                <div style={{ display: "flex", alignItems: "center", padding: "20px 35px" }}>
                    <p style={{ fontFamily: "Poppins-600", fontSize: "34px", color: "#345095", display: "flex", flexGrow: 1, margin: 0 }}>
                        Profile
                </p>
                ...
                <div style={{ margin: "0 35px 0 35px", display: "flex", flexDirection: "row" }}>
                    <div style={{ display: "flex", flexDirection: "row", flexGrow: 1 }}>
                        <p style={{ fontFamily: "Poppins-600", fontSize: "24px", color: "#3c64c7", margin: 0, }}>
                            52.6 GB free
                    </p>
                        <p style={{ fontFamily: "Poppins-600", fontSize: "18px", color: "#abc3fc", margin: "5px 0 0 0" }}>
                            &ensp;of 100 GB
                    </p>
                    </div>
                ...
                <div style={{
                    ...
                    <p style={{ fontFamily: "Poppins-600", fontSize: "16px", color: "#ff6aa2", margin: 0 }}>
                    ...
                    <Link to="#" style={{ textDecoration: "none" }}>
                        <div style={{
                            ...
                            <div style={{
                                ...
                                <p style={{ fontFamily: "Poppins-600", color: "#000", margin: 0 }}>
                                    Devices
                            </p>
